<template>
  <div >
     <b-form-select class="getselect"v-model="selected" :options="options">选择你添加的模块</b-form-select>
...
import certificate from './optionpersonmodel/certificate.vue';
import selfevaluation from './optionpersonmodel/selfevaluation.vue';
