<template>
    ...
    <div>
     <label for="example-datepicker" size="sm">学习开始时间</label>
        <b-form-datepicker id="datepicker-sm" v-model="edustrattime" size="sm" class="mb-2"></b-form-datepicker>
    
    <label for="example-datepicker" size="sm">学习结束时间</label>
        <b-form-datepicker id="datepicker-sm" v-model="eduendtime" size="sm" class="mb-2"></b-form-datepicker>
    </div>
    <label for="edcschool" size="sm">学校名称</label><input size="sm" type="text" id="edcschool" v-model="edcschool" required="required">
    <div class="description">
    <label for="edcdescription" size="sm">技能描述:</label><br>
    <b-form-textarea
      id="textarea"
