<template>
    ...
    <div>
     <label for="example-datepicker"  size="sm">工作开始时间</label>
        <b-form-datepicker id="datepicker-sm" v-model="workstrattime"  size="sm" class="mb-2"></b-form-datepicker>
    
    <label for="example-datepicker"  size="sm">工作结束时间</label>
        <b-form-datepicker id="datepicker-sm" v-model="workendtime"  size="sm" class="mb-2"></b-form-datepicker>
    </div>
    <label for="workposition"  size="sm">职位:</label><input type="text" id="workposition" v-model="workposition" required="required"  size="sm">
    <label for="workcompany"  size="sm">公司名称:</label><input type="text" id="workposition" v-model="workcompany" required="required"  size="sm">
    <div class="description"  size="sm">
    <label for="workdescription"  size="sm">职位描述:</label><br>
    <b-form-textarea
      id="textarea"
