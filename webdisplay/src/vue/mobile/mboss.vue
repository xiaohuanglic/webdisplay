        ...
        creatPersonal(Allchild,that){
         ...
         // console.log(sessionid)
                ...
                //    得到相关的修改图片的数据
                 ...
                 axios.post(url+'/task.php',{perbaseinfo:perbaseinfo}).then(res=>{
